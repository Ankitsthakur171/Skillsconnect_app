...
//
// class CvCardCollege extends StatelessWidget {
...
//                     wrapAfterWords(edu.degreeName, 4),
//                     wrapAfterWords(edu.instituteName, 4),
//                   ),
...
//   }
//
//   Widget _buildEducationRow(String iconPath, String degree, String institute) {
//     return Padding(
...
//                             const TextSpan(text: "\n"),
//                             TextSpan(
//                               text: institute, // 👈 institute normal
//                               style: const TextStyle(
//                                 fontSize: 14,
...
// }
//
// //   Widget _buildEducationRow(String iconPath, String title, String institute) {
// //     return Padding(
// //       padding: const EdgeInsets.symmetric(vertical: 6.0),
// //       child: Row(
// //         crossAxisAlignment: CrossAxisAlignment.start,
...
class CvCardCollege extends StatelessWidget {
  ...
  Widget _buildEducationRow(String iconPath, EducationItem edu) {
    return Padding(
      padding: const EdgeInsets.symmetric(vertical: 6.0),
      child: Row(
        crossAxisAlignment: CrossAxisAlignment.start,
