...
class InnerInterviewdetailpagewithjobid extends StatefulWidget {
  ...
  const InnerInterviewdetailpagewithjobid({
    super.key,
  ...
  @override
  State<InnerInterviewdetailpagewithjobid> createState() => _ApplicantCVScreenState();
}

class _ApplicantCVScreenState extends State<InnerInterviewdetailpagewithjobid>
      ...
      builder: (context, state) {
        ...
        return Scaffold(
          appBar: AppBar(
            ...
            title: Text('Interview Applicants',
