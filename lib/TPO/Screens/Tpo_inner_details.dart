...
import '../TpoInterviewStudent/tpointerinnerstate.dart';
import '../widgets/tpo_cv_card_certification.dart';
import '../widgets/tpo_cv_card_details.dart';


class TpoInnerDetails extends StatefulWidget {
  final int applicationId;
  final int userId;
  final int jobid;


  const TpoInnerDetails({
    super.key,
  ...
  @override
  State<TpoInnerDetails> createState() => _ApplicantCVScreenState();
}

class _ApplicantCVScreenState extends State<TpoInnerDetails>
  ...
  void initState() {
    ...
    // Future.microtask(() {
    //   context.read<Tpointerinnerbloc>().add(TpoInterviewLoadApplicant(
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<Tpointerinnerbloc, Tpointerinnerstate>(
