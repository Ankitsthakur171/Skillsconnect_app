...
class TpoCvCardExpierence extends StatelessWidget {
  final List<TpoExperience> experienceList;

  const TpoCvCardExpierence({super.key, required this.experienceList});
