...
// without the bottom  custim om bottom nav bar

class Jobscreenbtcustom extends StatefulWidget {
  const Jobscreenbtcustom({super.key});

  @override
  State<Jobscreenbtcustom> createState() => _JobscreenbtcustomState();
}

class _JobscreenbtcustomState extends State<Jobscreenbtcustom> {
  List<JobModelsd> jobs = [];
